...
# Round-3 cohort plots live in their own subdir — keeps r1/r2 unaffected.
PLOTS = REPO / "data_storage" / "things_on_paper" / "monitor" / "round3"
...
PAPER_SFT_BEAM30 = {"d=256r3": 26.1, "d=512r3": 29.5}

# Round 3 = fresh-from-scratch 256/512 with denser validation and the
# strict-/60 preservation rule active from day one. This plotter reads CSVs
# from monitor/round3/ and ignores rows for any other cohort.
ROUND_MODELS: dict[int, tuple[str, ...]] = {
    3: ("d=256r3", "d=512r3"),
}
MODEL_ORDER: tuple[str, ...] = ROUND_MODELS[3]
MODEL_COLORS = {
    "d=256r3": "#1f77b4",
    "d=512r3": "#ff7f0e",
}
...
PAPER_CONFUSION_ACC = {
    "SIGN":     {"d=256r3": 0.522, "d=512r3": 0.523},
    "OPERATOR": {"d=256r3": 0.943, "d=512r3": 0.941},
    "NUMBER":   {"d=256r3": 0.911, "d=512r3": 0.905},
}
