...
JF$Tokenize[line_String]:=StringSplit[StringReplace[line,{"P ":>"P","N ":>"N"," ~ ":>"~"," ~":>"~","~ ":>"~"}]," "]/.{
...
MMAExprToJFString$NumberFormat[num_Integer]:={If[num>0,"P","N"],"~"}~Join~Riffle[IntegerDigits[num,100],"~"];
