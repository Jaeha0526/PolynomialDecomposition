...
{result,sub1,sub2,short,bindices,bindices$max},
result=StringSplit[pred,"&"];
If[Length[result]=!=3,Print["ReadPredictionString failure 1"];Return[False]];
{short, sub1, sub2}=result;
result={short, {sub1, sub2}}/. str_String:>JF$Parser[str];
