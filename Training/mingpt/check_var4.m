...
{result,sub1,sub2,sub3,sub4,short,bindices,bindices$max},
result=StringSplit[pred,"&"];
If[Length[result]=!=5,Print["ReadPredictionString failure 1"];Return[False]];
{short, sub1, sub2, sub3, sub4}=result;
result={short, {sub1, sub2, sub3, sub4}}/. str_String:>JF$Parser[str];
...
long=JF$Parser[str1];
{short,sublist}=ReadPredictionString[str2];
