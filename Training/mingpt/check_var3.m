...
{result,sub1,sub2,sub3,short,bindices,bindices$max},
result=StringSplit[pred,"&"];
If[Length[result]=!=4,Print["ReadPredictionString failure 1"];Return[False]];
{short, sub1, sub2, sub3}=result;
result={short, {sub1, sub2, sub3}}/. str_String:>JF$Parser[str];
