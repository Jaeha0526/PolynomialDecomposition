...
#    --reading_params_path ../../../data_storage/things_on_paper/model/model8_256_best.pt \
#    --outputs_path ../nanogpt/symbolic/predictions/check8_256_beam.txt
...
python ../nanogpt/run.py debug_beam \
   ...
   --evaluate_corpus_path ../../../data_storage/things_on_paper/dataset/data3_test_use_this.txt \
   --reading_params_path ../../../data_storage/things_on_paper/model/model8_256_best.pt \
   --outputs_path ../nanogpt/symbolic/predictions/check8_256_beam_30.txt
...
python3 ../nanogpt/run.py debug_beam \
   ...
   --evaluate_corpus_path ../../../data_storage/things_on_paper/dataset/data3_test_use_this.txt \
   --reading_params_path ../../../data_storage/things_on_paper/model/model8_256_add1M_best.pt \
   --outputs_path ../nanogpt/symbolic/predictions/check8_256_add1M_beam_30.txt
