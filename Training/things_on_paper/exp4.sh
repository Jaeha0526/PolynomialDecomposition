...
#    --outputs_path ../mingpt/symbolic/predictions/check4_beam.txt
...
#    --outputs_path ../mingpt/symbolic/predictions/check4_add1M_beam.txt
...
python ../mingpt/run.py debug_beam \
   ...
   --outputs_path ../mingpt/symbolic/predictions/check4_add1M_beam2.txt
