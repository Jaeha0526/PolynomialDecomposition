...
#    --beam_width 30 \
#    --max_test 300 \
#    --check_path ../mingpt/check_var4.m \
#    --evaluate_corpus_path ../../../data_storage/things_on_paper/dataset/data8_test.txt \
#    --reading_params_path ../../../data_storage/things_on_paper/model/model16_best.pt \
#    --outputs_path ../mingpt/symbolic/predictions/check16_beam.txt
...
#    --evaluate_corpus_path ../../../data_storage/things_on_paper/dataset/data8_test.txt \
#    --reading_params_path ../../../data_storage/things_on_paper/model/model16_2_best.pt \
#    --outputs_path ../mingpt/symbolic/predictions/check16_beam_2.txt
...
#    --evaluate_corpus_path ../../../data_storage/things_on_paper/dataset/data8_test.txt \
#    --reading_params_path ../../../data_storage/things_on_paper/model/model16_3_best.pt \
#    --outputs_path ../mingpt/symbolic/predictions/check16_beam_3.txt
...
#    --outputs_path ../mingpt/symbolic/predictions/check16_beam_4.txt
...
#    --reading_params_path ../../../data_storage/things_on_paper/model/model16_4_best.pt \
#    --outputs_path ../mingpt/symbolic/predictions/check16_beam_5.txt
...
#    --reading_params_path ../../../data_storage/things_on_paper/model/model16_4_best.pt \
#    --outputs_path ../mingpt/symbolic/predictions/check16_beam_DAG.txt
...
python ../mingpt/run.py debug_beam \
   ...
   --reading_params_path ../../../data_storage/things_on_paper/model/model16_4_best.pt \
   --outputs_path ../mingpt/symbolic/predictions/check16_beam_DAG_large.txt
